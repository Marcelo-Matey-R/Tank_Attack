...
void Map::SetTankOfPlayer1()
{
    ...
    do
    {
        pos1.i = disRows(gen);
        pos1.j = disCols(gen);
    } while (!IsNullPlace(pos1));

    Tank *tankBlue1 = new TankLightBlueAndBlue(ColorTank::BLUE);
    tanksPlayer0[0] = tankBlue1;
    tankBlue1->SetPosition(pos1);
    map[pos1.i][pos1.j] = tankBlue1;
    ...
    do
    {
        pos2.i = disRows(gen);
        pos2.j = disCols(gen);
    } while (!IsNullPlace(pos2));

    Tank *tankBlue2 = new TankLightBlueAndBlue(ColorTank::BLUE);
    tanksPlayer0[1] = tankBlue2;
    tankBlue2->SetPosition(pos2);
    map[pos2.i][pos2.j] = tankBlue2;
    ...
    do
    {
        pos3.i = disRows(gen);
        pos3.j = disCols(gen);
    } while (!IsNullPlace(pos3));

    Tank *tankRed1 = new TankYellowAndRed(ColorTank::RED);
    tanksPlayer0[2] = tankRed1;
    tankRed1->SetPosition(pos3);
    map[pos3.i][pos3.j] = tankRed1;
    ...
    do
    {
        pos4.i = disRows(gen);
        pos4.j = disCols(gen);
    } while (!IsNullPlace(pos4));

    Tank *tankRed2 = new TankYellowAndRed(ColorTank::RED);
    tanksPlayer0[3] = tankRed2;
    tankRed2->SetPosition(pos4);
    map[pos4.i][pos4.j] = tankRed2;
}
...
void Map::SetTankOfPlayer2()
{
    ...
    Tank *tankLightBlue1 = new TankLightBlueAndBlue(ColorTank::LIGTHBLUE);
    tanksPlayer1[0] = tankLightBlue1;
    tankLightBlue1->SetPosition(pos1);
    map[pos1.i][pos1.j] = tankLightBlue1;
    ...
    Tank *tankLightBlue2 = new TankLightBlueAndBlue(ColorTank::LIGTHBLUE);
    tanksPlayer1[1] = tankLightBlue2;
    tankLightBlue2->SetPosition(pos2);
    map[pos2.i][pos2.j] = tankLightBlue2;
    ...
    Tank *tankYellow1 = new TankYellowAndRed(ColorTank::YELLOW);
    tanksPlayer1[2] = tankYellow1;
    tankYellow1->SetPosition(pos3);
    map[pos3.i][pos3.j] = tankYellow1;
    ...
    Tank *tankYellow2 = new TankYellowAndRed(ColorTank::YELLOW);
    tanksPlayer1[3] = tankYellow2;
    tankYellow2->SetPosition(pos4);
    map[pos4.i][pos4.j] = tankYellow2;
}
